...
//altsyncram ADDRESS_ACLR_A="NONE" CLOCK_ENABLE_INPUT_A="BYPASS" CLOCK_ENABLE_OUTPUT_A="BYPASS" DEVICE_FAMILY="Cyclone IV GX" ENABLE_RUNTIME_MOD="NO" INIT_FILE="rom_3.mif" NUMWORDS_A=8 OPERATION_MODE="ROM" OUTDATA_ACLR_A="NONE" OUTDATA_REG_A="UNREGISTERED" WIDTH_A=3 WIDTH_BYTEENA_A=1 WIDTHAD_A=3 address_a clock0 q_a
...
`endif
	...
	defparam
		...
		ram_block1a_0.init_file = "rom_3.mif",
		ram_block1a_0.init_file_layout = "port_a",
		ram_block1a_0.logical_ram_name = "ALTSYNCRAM",
		ram_block1a_0.mem_init0 = 8'hD6,
	...
	defparam
		...
		ram_block1a_1.init_file = "rom_3.mif",
	...
	defparam
		...
		ram_block1a_2.init_file = "rom_3.mif",
...
`endif
	...
	rom3_ex_altsyncram	rom3_ex_altsyncram_component (
				.address_a (address),
				.clock0 (clock),
				.q_a (sub_wire0));
